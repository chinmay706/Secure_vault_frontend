  ...
  return (
    <div className="h-full flex flex-col">
      <div className="shrink-0 pb-4 sm:pb-6">
        <h1 className="text-xl sm:text-2xl font-bold text-foreground">File Management</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1 sm:mt-2 text-sm sm:text-base">Manage files across all users</p>
      </div>
